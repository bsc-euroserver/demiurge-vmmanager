...
import static es.bsc.demiurge.cloudsuiteperformancedriver.models.PerformanceValue.DESCENDANT_PERFORMANCE;

public enum CloudSuiteBenchmark {

    //DATA_ANALYTICS(new VmSize(1, 4, 100), new VmSize(32, 28, 150), DESCENDANT_PERFORMANCE),
    DATA_ANALYTICS(new VmSize(1, 1, 5), new VmSize(32, 28, 150), DESCENDANT_PERFORMANCE),
    ...
    GRAPH_ANALYTICS(new VmSize(1, 8, 10), new VmSize(32, 20, 50), DESCENDANT_PERFORMANCE),
    ...
    //IN_MEMORY_ANALYTICS(new VmSize(1, 1, 5), new VmSize(32, 28, 150), PerformanceValue.DESCENDANT_PERFORMANCE);
