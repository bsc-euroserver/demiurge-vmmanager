...
public class PerformanceVmManager extends GenericVmManager {
    ...
    public double getClusterConsumption() {
        ...
        for (Host h : hosts){
            ...
            if (h.getAssignedCpus() > 0){
                if (checkJunoSamePlatform(h.getHostname())){
                    pow += h.getIdlePower()/2;
                }else{
                    pow += h.getIdlePower();
                }
            }
        ...
        for (VmDeployed vm : vms.getVms()){
            ...
            //System.out.println("vmPowerEstimation: " + vmPowerEstimation);
...
/*
            if (hmap.get(hostName) == 0){
               ...
               if (!checkJunoSamePlatform(host.getHostname())){
                    pow += host.getIdlePower();
                }
    ...
    private boolean checkJunoSamePlatform(String hostname) {
        if (hostname.equals("host0")){
            if (getHost("host1").getAssignedCpus() > 0)
                return true;
            else return false;
        }else if (hostname.equals("host2")){
            if (getHost("host3").getAssignedCpus() > 0)
                return true;
            else return false;
        }else if (hostname.equals("host4")){
            if (getHost("host5").getAssignedCpus() > 0)
                return true;
            else return false;
        }else if (hostname.equals("host6")){
            if (getHost("host7").getAssignedCpus() > 0)
                return true;
            else return false;
        }else if (hostname.equals("host8")){
            if (getHost("host9").getAssignedCpus() > 0)
                return true;
            else return false;
        }else if (hostname.equals("host10")){
            if (getHost("host11").getAssignedCpus() > 0)
                return true;
            else return false;
        }else if (hostname.equals("host12")){
            if (getHost("host13").getAssignedCpus() > 0)
                return true;
            else return false;
        }else if (hostname.equals("host14")){
            if (getHost("host15").getAssignedCpus() > 0)
                return true;
            else return false;
        }else if (hostname.equals("host16")){
            if (getHost("host17").getAssignedCpus() > 0)
                return true;
            else return false;
        }else if (hostname.equals("host18")){
            if (getHost("host19").getAssignedCpus() > 0)
                return true;
            else return false;
        }

        else if (hostname.equals("host19")){
            if (getHost("host18").getAssignedCpus() > 0)
                return true;
            else return false;
        }else if (hostname.equals("host17")){
            if (getHost("host16").getAssignedCpus() > 0)
                return true;
            else return false;
        }else if (hostname.equals("host15")){
            if (getHost("host14").getAssignedCpus() > 0)
                return true;
            else return false;
        }else if (hostname.equals("host13")){
            if (getHost("host12").getAssignedCpus() > 0)
                return true;
            else return false;
        }else if (hostname.equals("host11")){
            if (getHost("host10").getAssignedCpus() > 0)
                return true;
            else return false;
        }else if (hostname.equals("host9")){
            if (getHost("host8").getAssignedCpus() > 0)
                return true;
            else return false;
        }else if (hostname.equals("host7")){
            if (getHost("host6").getAssignedCpus() > 0)
                return true;
            else return false;
        }else if (hostname.equals("host5")){
            if (getHost("host4").getAssignedCpus() > 0)
                return true;
            else return false;
        }else if (hostname.equals("host3")){
            if (getHost("host2").getAssignedCpus() > 0)
                return true;
            else return false;
        }else if (hostname.equals("host1")){
            if (getHost("host0").getAssignedCpus() > 0)
                return true;
            else return false;
        }else
            return false;
